...
public:
    ...
    {
        return StrategyEnum::HumanControlledStrategy;
    }
...
/*
 *      This player lost his job, failed his classes, and lost his girlfriend to his roommate. He is out for vengenance
 *  and is full out aggressive. Lacking any moral compass, he selects anyone to attack and will fight to the death.  
 */
...
public:
    ...
    StrategyEnum::StrategyEnum getIdentifier()
    {
        return StrategyEnum::ObtainSmallestContinentsFirstStrategy;
    }
    virtual std::vector<std::pair<int, int>> place(GameState state, int numTroops);
    virtual std::pair<int, int> attack(GameState state);
    virtual std::vector<std::tuple<int, int, int> > fortify(GameState state);
...
public:
    ...
    StrategyEnum::StrategyEnum getIdentifier()
    {
        return StrategyEnum::BadStrategy1;
    }
    virtual int claim(GameState state);
    virtual std::vector<std::pair<int, int>> place(GameState state, int numTroops);
    virtual std::pair<int, int> attack(GameState state);
