...
void GameSlave::runIt()
{
	while (true)
	{
		...
		if (task.players[0]==StrategyEnum::NOPLAYER && task.players[1]==StrategyEnum::NOPLAYER && task.players[2]==StrategyEnum::NOPLAYER && task.players[3]==StrategyEnum::NOPLAYER && task.players[4]==StrategyEnum::NOPLAYER && task.players[5]==StrategyEnum::NOPLAYER)
